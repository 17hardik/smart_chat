...
public class ContactUs extends AppCompatActivity implements AIListener{
            ...
            protected void populateViewHolder(ChatRecording viewHolder, ChatMessage model, int position) {
                if (model.getMsgUser().equals(phone)) {
                    ...
                    if (model.getMsgText().equals("")) {
                        viewHolder.leftText.setText("As I am a programmed bot so I am unable to answer your complex questions like this, please contact developer on 17hardik.sharma@gmail.com.");
                        if(!isFisrtTime) {
    ...
    public void sendMail(){
        String recipient = "17hardik.sharma@gmail.com";
